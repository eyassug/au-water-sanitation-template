...
urlpatterns = patterns('',
    ...
    url(r'^countryStatusDelete/(?P<pk>\d+)/delete/$', views.CountryStatusDelete.as_view(), name='delete_employee'),
    ...
    url(r'^prioritystatusdelete/(?P<pk>\d+)/delete/$', views.PriorityAreaStatusDelete.as_view(), name='country_status_delete'),
    ...
    url(r'^sectorperformancedelete/(?P<pk>\d+)/delete/$', views.SectorPerformanceDelete.as_view(), name='sector_performance_delete'),
    ...
    url(r'^facilityaccessdelete/(?P<pk>\d+)/delete/$', views.FacilityAccessDelete.as_view(), name='facility_access_delete'),
    ...
    url(r'^planningperformancedelete/(?P<pk>\d+)/delete/$', views.PlanningPerformanceDelete.as_view(), name='planning_performance_delete'),
    ...
    url(r'^tenderprocperformancedelete/(?P<pk>\d+)/delete/$', views.TenderProcedurePerformanceDelete.as_view(), name='tender_proc_performance_delete'),
    ...
    url(r'^communityapproachdelete/(?P<pk>\d+)/delete/$', views.CommunityApproachDelete.as_view(), name='community_approach_delete'),
    ...
    url(r'^partnercontributiondelete/(?P<pk>\d+)/delete/$', views.PartnerContributionDelete.as_view(), name='partner_contribution_delete'),
    ...
    url(r'^partnereventcontributiondelete/(?P<pk>\d+)/delete/$', views.PartnerEventContributionDelete.as_view(), name='partner_event_contribution_delete'),
    ...
    url(r'^swotdelete/(?P<pk>\d+)/delete/$', views.SWOTDelete.as_view(), name='swot_delete'),
    #Report url
