...
urlpatterns = patterns('',
    ...
    url(r'^(?i)report/prioritystatus/(?P<id>[0-9]+)/$', views.PriorityAreaStatusCreate.as_view(), name='country_status_create'),
    ...
    url(r'^(?i)report/sectorperformance/(?P<id>[0-9]+)/$', views.SectorPerformanceCreate.as_view(), name='sector_performance_create'),    
    ...
    url(r'^(?i)report/facilityaccess/(?P<id>[0-9]+)/$', views.FacilityAccessCreate.as_view(), name='facility_access_create'),
    ...
    url(r'^(?i)report/planningperformance/(?P<id>[0-9]+)/$', views.PlanningPerformanceCreate.as_view(), name='planning_performance_create'),
    ...
    url(r'^(?i)report/tenderprocperformance/(?P<id>[0-9]+)/$', views.TenderProcedurePerformanceCreate.as_view(), name='tender_proc_performance_create'),
    ...
    url(r'^(?i)report/communityapproach/(?P<id>[0-9]+)/$', views.CommunityApproachCreate.as_view(), name='community_approach_create'),
    ...
    url(r'^(?i)report/partnercontribution/(?P<id>[0-9]+)/$', views.PartnerContributionCreate.as_view(), name='partner_contribution_create'),
    ...
    url(r'^(?i)report/partnereventcontribution/(?P<id>[0-9]+)/$', views.PartnerEventContributionCreate.as_view(), name='partner_event_contribution_create'),
    ...
    url(r'^(?i)report/swot/(?P<id>[0-9]+)/$', views.SWOTAndConclusionCreate.as_view(), name='swot_create'),
    #Report url
