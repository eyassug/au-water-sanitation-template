...
class FacilityAccess(models.Model):
    ...
    year = models.ForeignKey('Period')
    planned = models.PositiveSmallIntegerField() 
    planned_pop_affected = models.PositiveSmallIntegerField() 
    actual = models.PositiveSmallIntegerField() 
    actual_pop_affected = models.PositiveSmallIntegerField() 
    secured = models.PositiveSmallIntegerField()
    secured_pop_affected = models.PositiveSmallIntegerField() 
