...
class FacilityAccess(models.Model):
    ...
    planned = models.PositiveIntegerField(blank=True, null=False) 
    planned_pop_affected = models.PositiveIntegerField(blank=True, null=False) 
    actual = models.PositiveIntegerField(blank=True, null=False) 
    actual_pop_affected = models.PositiveIntegerField(blank=True, null=False) 
    secured = models.PositiveIntegerField(blank=True, null=False)
    secured_pop_affected = models.PositiveIntegerField(blank=True, null=False) 
    unit_cost = models.DecimalField(max_digits=19, decimal_places=2, null=False, blank=True)
    house_hold_contribution = models.DecimalField(max_digits=5, decimal_places=2, null=False, blank=True)
    government_contribution = models.DecimalField(max_digits=5, decimal_places=2, null=False, blank=True)
...
class SectorPerformance(models.Model):
    ...
    year = models.ForeignKey('Period')
    coverage_target = models.DecimalField(max_digits=5, decimal_places=2, null=False, blank=True)
    coverage_achieved = models.DecimalField(max_digits=5, decimal_places=2, null=False, blank=True)
    fund_needed = models.DecimalField(max_digits=15, decimal_places=2, null=False, blank=True)
    fund_mobilised = models.DecimalField(max_digits=15, decimal_places=2, null=False, blank=True )
    fund_availed = models.DecimalField(max_digits=15, decimal_places=2, null=False, blank=True)
    fund_used = models.DecimalField(max_digits=15, decimal_places=2, null=False, blank=True)
...
class PlanningPerformance(models.Model):
    ...
    sector_category = models.ForeignKey('SectorCategory', blank=False)
    year = models.ForeignKey('Period')
    plan_preparation_delay = models.PositiveSmallIntegerField(null=False,blank=True)    
    plan_adoption_delay = models.PositiveSmallIntegerField(null=False,blank=True)
    general_comment = models.TextField(blank=True)
    bottlenecks = models.TextField(blank=True)
    measures_taken = models.TextField(blank=True)
    success_challenges = models.TextField(blank=True)
...
class CommunityApproach(models.Model):
    ...
    approach_name = models.CharField(max_length=120, null=False, blank=True)    
    description = models.TextField(blank=True)
    cost_per_capita = models.DecimalField(max_digits=10, decimal_places=2, null=False, blank=True)
...
class PartnerContribution(models.Model):
    ...
    annual_contribution = models.DecimalField(max_digits=15, decimal_places=4, null=False,blank=True)
    in_kind_contribution = models.DecimalField(max_digits=5, decimal_places=2, null=False,blank=True)
    financial_contribution = models.DecimalField(max_digits=5, decimal_places=2, null=False,blank=True)
...
class PartnerEventContribution(models.Model):
    ...
    government_staff_contribution = models.DecimalField(max_digits=10, decimal_places=2, null=False,blank=True)
    own_staff_contribution = models.DecimalField(max_digits=10, decimal_places=2, null=False,blank=True)
    total_budget_contributed_to_country = models.DecimalField(max_digits=14, decimal_places=2, null=False,blank=True)
    class Meta:
        unique_together = ("country", "sector_category", "year")
        ordering = ['country']
